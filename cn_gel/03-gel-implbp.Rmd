...
## Determine Traits Of Interest {#gel-implbp-dettrint} 
...
At this stage of our analysis, we are ignoring all traits replated to reproduction or survival of calves which are also important for the economic profitability of the production herd. For the moment, we focus on the three traits listed above. This means, we construct the aggregate genotype based on the three traits _CC_, _CF_, and _CW_. 
