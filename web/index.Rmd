...
sBaseUrl <- 'https://github.com/charlotte-ngs/GELASMSS2019/'
...
vec_topics_schedule[which(Datum == format(as.Date("2019/02/18"), "%d.%m"))] <- ""
vec_topics_schedule[which(Datum == format(as.Date("2019/02/25"), "%d.%m"))] <- ""
vec_topics_schedule[which(Datum == format(as.Date("2019/03/04"), "%d.%m"))] <- ""
vec_topics_schedule[which(Datum == format(as.Date("2019/03/11"), "%d.%m"))] <- ""
vec_topics_schedule[which(Datum == format(as.Date("2019/03/18"), "%d.%m"))] <- ""
vec_topics_schedule[which(Datum == format(as.Date("2019/03/25"), "%d.%m"))] <- ""
vec_topics_schedule[which(Datum == format(as.Date("2019/04/01"), "%d.%m"))] <- ""
vec_topics_schedule[which(Datum == format(as.Date("2019/04/08"), "%d.%m"))] <- ""
vec_topics_schedule[which(Datum == format(as.Date("2019/04/15"), "%d.%m"))] <- ""
vec_topics_schedule[which(Datum == format(as.Date("2019/04/29"), "%d.%m"))] <- ""
vec_topics_schedule[which(Datum == format(as.Date("2019/05/06"), "%d.%m"))] <- ""
vec_topics_schedule[which(Datum == format(as.Date("2019/05/13"), "%d.%m"))] <- ""
...
vec_topics_notes[which(Datum == format(as.Date("2019/02/18"), "%d.%m"))] <- paste0("[](", s_cn_url, "", ")") 
vec_topics_notes[which(Datum == format(as.Date("2019/02/25"), "%d.%m"))] <- paste0("[](", s_cn_url, "", ")") 
vec_topics_notes[which(Datum == format(as.Date("2019/03/04"), "%d.%m"))] <- paste0("[](", s_cn_url, "", ")") 
vec_topics_notes[which(Datum == format(as.Date("2019/03/11"), "%d.%m"))] <- paste0("[](", s_cn_url, "", ")") 
vec_topics_notes[which(Datum == format(as.Date("2018/03/18"), "%d.%m"))] <- paste0("[](", s_cn_url, "", ")") 
vec_topics_notes[which(Datum == format(as.Date("2018/03/25"), "%d.%m"))] <- paste0("[](", s_cn_url, "", ")") 
...
# links zu slides
vec_topics_slides[which(Datum == format(as.Date("2019/02/18"), "%d.%m"))] <- paste0("[](", s_cn_url, "", ")") 
vec_topics_slides[which(Datum == format(as.Date("2019/02/25"), "%d.%m"))] <- paste0("[](", s_cn_url, "", ")") 
vec_topics_slides[which(Datum == format(as.Date("2019/03/04"), "%d.%m"))] <- paste0("[](", s_cn_url, "", ")") 
vec_topics_slides[which(Datum == format(as.Date("2019/03/11"), "%d.%m"))] <- paste0("[](", s_cn_url, "", ")") 
vec_topics_slides[which(Datum == format(as.Date("2018/03/18"), "%d.%m"))] <- paste0("[](", s_cn_url, "", ")") 
vec_topics_slides[which(Datum == format(as.Date("2018/03/25"), "%d.%m"))] <- paste0("[](", s_cn_url, "", ")") 

vec_topics_slides[which(Datum == format(as.Date("2019/04/01"), "%d.%m"))] <- paste0("[](", s_cn_gel_url, "", ")")
vec_topics_slides[which(Datum == format(as.Date("2019/04/08"), "%d.%m"))] <- paste0("[](", s_cn_gel_url, "", ")")
vec_topics_slides[which(Datum == format(as.Date("2019/04/15"), "%d.%m"))] <- paste0("[](", s_cn_gel_url, "", ")")
vec_topics_slides[which(Datum == format(as.Date("2019/04/29"), "%d.%m"))] <- paste0("[](", s_cn_gel_url, "", ")")
vec_topics_slides[which(Datum == format(as.Date("2019/05/06"), "%d.%m"))] <- paste0("[](", s_cn_gel_url, "", ")")
vec_topics_slides[which(Datum == format(as.Date("2019/05/13"), "%d.%m"))] <- paste0("[](", s_cn_gel_url, "", ")")
...
vec_topics_ex[which(Datum == format(as.Date("2019/02/18"), "%d.%m"))] <- paste0("[](", s_cn_url, "", ")") 
vec_topics_ex[which(Datum == format(as.Date("2019/02/25"), "%d.%m"))] <- paste0("[](", s_cn_url, "", ")") 
vec_topics_ex[which(Datum == format(as.Date("2019/03/04"), "%d.%m"))] <- paste0("[](", s_cn_url, "", ")") 
vec_topics_ex[which(Datum == format(as.Date("2019/03/11"), "%d.%m"))] <- paste0("[](", s_cn_url, "", ")") 
vec_topics_ex[which(Datum == format(as.Date("2018/03/18"), "%d.%m"))] <- paste0("[](", s_cn_url, "", ")") 
vec_topics_ex[which(Datum == format(as.Date("2018/03/25"), "%d.%m"))] <- paste0("[](", s_cn_url, "", ")") 
vec_topics_ex[which(Datum == format(as.Date("2019/04/01"), "%d.%m"))] <- paste0("[](", s_cn_gel_url, "", ")")
vec_topics_ex[which(Datum == format(as.Date("2019/04/08"), "%d.%m"))] <- paste0("[](", s_cn_gel_url, "", ")")
vec_topics_ex[which(Datum == format(as.Date("2019/04/15"), "%d.%m"))] <- paste0("[](", s_cn_gel_url, "", ")")
vec_topics_ex[which(Datum == format(as.Date("2019/04/29"), "%d.%m"))] <- paste0("[](", s_cn_gel_url, "", ")")
vec_topics_ex[which(Datum == format(as.Date("2019/05/06"), "%d.%m"))] <- paste0("[](", s_cn_gel_url, "", ")")
vec_topics_ex[which(Datum == format(as.Date("2019/05/13"), "%d.%m"))] <- paste0("[](", s_cn_gel_url, "", ")")
...
vec_topics_sol[which(Datum == format(as.Date("2019/02/18"), "%d.%m"))] <- paste0("[](", s_cn_url, "", ")") 
vec_topics_sol[which(Datum == format(as.Date("2019/02/25"), "%d.%m"))] <- paste0("[](", s_cn_url, "", ")") 
vec_topics_sol[which(Datum == format(as.Date("2019/03/04"), "%d.%m"))] <- paste0("[](", s_cn_url, "", ")") 
vec_topics_sol[which(Datum == format(as.Date("2019/03/11"), "%d.%m"))] <- paste0("[](", s_cn_url, "", ")") 
vec_topics_sol[which(Datum == format(as.Date("2018/03/18"), "%d.%m"))] <- paste0("[](", s_cn_url, "", ")") 
vec_topics_sol[which(Datum == format(as.Date("2018/03/25"), "%d.%m"))] <- paste0("[](", s_cn_url, "", ")") 
vec_topics_sol[which(Datum == format(as.Date("2019/04/01"), "%d.%m"))] <- paste0("[](", s_cn_gel_url, "", ")")
vec_topics_sol[which(Datum == format(as.Date("2019/04/08"), "%d.%m"))] <- paste0("[](", s_cn_gel_url, "", ")")
vec_topics_sol[which(Datum == format(as.Date("2019/04/15"), "%d.%m"))] <- paste0("[](", s_cn_gel_url, "", ")")
vec_topics_sol[which(Datum == format(as.Date("2019/04/29"), "%d.%m"))] <- paste0("[](", s_cn_gel_url, "", ")")
vec_topics_sol[which(Datum == format(as.Date("2019/05/06"), "%d.%m"))] <- paste0("[](", s_cn_gel_url, "", ")")
vec_topics_sol[which(Datum == format(as.Date("2019/05/13"), "%d.%m"))] <- paste0("[](", s_cn_gel_url, "", ")")
