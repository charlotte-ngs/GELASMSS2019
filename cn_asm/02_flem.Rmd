...
Taking the equations as shown in \@ref(eq:basisstatisticalmodel) for all obserations ($i=1, \ldots, N$) and expressing them in matrix-vector notation, we get
...
A widely use example dataset for such a simple regression analysis in animal breeding consists of measurements of body weight and breast circumference for a given group of animals.
